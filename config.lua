...
Config.Text = {
    ...
    ['Pickaxe_Bought'] = 'You have bought a drill for $' ..MiningJob.PickAxePrice.. ' ... Good luck!',
    ['Pickaxe_Check'] = 'It looks like you already have a drill',
    ['MiningAlert'] = 'My eye just caught something shiny',
    ['StartMining'] = '[E] Start Mining',

    ['error_mining'] = 'You dont have a drill to start mining',
